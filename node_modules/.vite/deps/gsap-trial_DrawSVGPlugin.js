...
var p = (e2, t2) => c(e2.getAttribute(t2));
var w = Math.sqrt;
var y = (e2, t2, n2, i2, r2, s2) => w(((c(n2) - c(e2)) * r2) ** 2 + ((c(i2) - c(t2)) * s2) ** 2);
var _ = (e2) => console.warn(e2);
...
var S = (e2) => {
  ...
  x(e2) && (k2 = e2.getScreenCTM(), m2 = w(k2.a * k2.a + k2.b * k2.b), k2 = w(k2.d * k2.d + k2.c * k2.c));
  try {
    i2 = e2.getBBox();
  } catch (e3) {
  ...
  if (i2 && (P2 || S2) || !f[c2] || (P2 = p(e2, f[c2][0]), S2 = p(e2, f[c2][1]), "rect" !== c2 && "line" !== c2 && (P2 *= 2, S2 *= 2), "line" === c2 && (v2 = p(e2, "x1"), b2 = p(e2, "y1"), P2 = Math.abs(P2 - v2), S2 = Math.abs(S2 - b2))), "path" === c2)
    o2 = u2.strokeDasharray, u2.strokeDasharray = "none", n2 = e2.getTotalLength() || 0, g(m2) !== g(k2) && !s && (s = 1) && _("Warning: <path> length cannot be measured when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."), n2 *= (m2 + k2) / 2, u2.strokeDasharray = o2;
  else if ("rect" === c2)
    n2 = 2 * P2 * m2 + 2 * S2 * k2;
  else if ("line" === c2)
    n2 = y(v2, b2, v2 + P2, b2 + S2, m2, k2);
  else if ("polyline" === c2 || "polygon" === c2)
    for (r2 = e2.getAttribute("points").match(h) || [], "polygon" === c2 && r2.push(r2[0], r2[1]), n2 = 0, a2 = 2; a2 < r2.length; a2 += 2)
      n2 += y(r2[a2 - 2], r2[a2 - 1], r2[a2], r2[a2 + 1], m2, k2) || 0;
  else
    "circle" !== c2 && "ellipse" !== c2 || (l2 = P2 / 2 * m2, d2 = S2 / 2 * k2, n2 = Math.PI * (3 * (l2 + d2) - w((3 * l2 + d2) * (l2 + 3 * d2))));
  return n2 || 0;
};
var T = (e2, i2) => {
  if (!(e2 = t(e2)[0]))
...
var O = { version: "3.12.5", name: "drawSVG", register(t2) {
  e = t2, D();
}, init(e2, t2, s2, a2, l2) {
  if (!e2.getBBox)
    return false;
  r || D();
  let d2, h2, f2, p2 = S(e2);
  return this.styles = o && o(e2, "strokeDashoffset,strokeDasharray,strokeMiterlimit"), this.tween = s2, this._style = e2.style, this._target = e2, t2 + "" == "true" ? t2 = "0 100%" : t2 ? -1 === (t2 + "").indexOf(" ") && (t2 = "0 " + t2) : t2 = "0 0", d2 = T(e2, p2), h2 = ((e3, t3, n2) => {
  ...
  })(t2, p2, d2[0]), this._length = g(p2), this._dash = g(d2[1] - d2[0]), this._offset = g(-d2[0]), this._dashPT = this.add(this, "_dash", this._dash, g(h2[1] - h2[0]), 0, 0, 0, 0, 0, 1), this._offsetPT = this.add(this, "_offset", this._offset, g(-h2[0]), 0, 0, 0, 0, 0, 1), i && (f2 = n.getComputedStyle(e2), f2.strokeLinecap !== f2.strokeLinejoin && (h2 = c(f2.strokeMiterlimit), this.add(e2.style, "strokeMiterlimit", h2, h2 + 0.01))), this._live = x(e2) || ~(t2 + "").indexOf("live"), this._nowrap = ~(t2 + "").indexOf("nowrap"), this._props.push("drawSVG"), P;
}, render(e2, t2) {
  if (t2.tween._time || !a()) {
    let n2, i2, r2, s2, o2 = t2._pt, a2 = t2._style;
    if (o2) {
      for (t2._live && (n2 = S(t2._target), n2 !== t2._length && (i2 = n2 / t2._length, t2._length = n2, t2._offsetPT && (t2._offsetPT.s *= i2, t2._offsetPT.c *= i2), t2._dashPT ? (t2._dashPT.s *= i2, t2._dashPT.c *= i2) : t2._dash *= i2)); o2; )
        o2.r(e2, o2.d), o2 = o2._next;
